            ...
            <div className="navbar fixed z-20 bg-opacity-40 bg-slate-600 text-black">
                <div className="navbar-start">
                    ...
                    <div className="btn btn-ghost text-black text-xl lg:text-2xl font-bold">
                        <img className='hidden lg:grid md:grid w-[70px] h-[48px] bg-none' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRdTURLkGfp83BaVsBR7Ng4gAc4gaMxLJGF5A&s" alt="" />
                        Task<span className='text-[#a00000]'>Trackr</span>
                    </div>
                </div>
                ...
                <div className="navbar-end">
                    {user ? (
                        <>
                            ...
                            <button onClick={handleLogOut} className="btn btn-sm bg-[#a00000] border-white text-white ml-1">Sign out</button>
    
                        </>
                    ) : (
                        <>
                            <Link to="/login"><button className="btn btn-sm bg-[#a00000] border-white text-white">Sign in</button></Link>
                            <Link to="/register"><button className="btn btn-sm bg-[#a00000] border-white text-white hidden lg:block">Sign up</button></Link>
                        </>
                    )}
                </div>
            </div>
